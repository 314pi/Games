...
user in an INI file next to 4stAttackPortable.exe called 4stAttackPortable.ini.
...
copy AppNamePortable.ini from this directory to 4stAttackPortable.ini next to
4stAttackPortable.exe. The options in the INI file are as follows:
